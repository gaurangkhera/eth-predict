...
from hack.forms import LoginForm, RegForm, EthForm
...
def home():
    ...
    if form.validate_on_submit():
        data = pd.read_csv('hack/static/data.csv', sep=',')
        data = data[['Close', 'Open', 'Volume_USD', 'Volume_CCY']]

        data['Open'] = form.open.data
        data['Volume_USD'] = form.volume_usd.data
        data['Volume_CCY'] = form.volume_ccy.data
        ...
        pickle_in = open('hack/static/model.pickle', 'rb')
